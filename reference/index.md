...
Discover available APIs in the bundled registry.
...
Explore specs and call endpoints.
...
- [`bundeshaushalt_budget_data()`](https://buecker.ms/bunddev/reference/bundeshaushalt_budget_data.md)
...
- [`bundestag_lobbyregister_search()`](https://buecker.ms/bunddev/reference/bundestag_lobbyregister_search.md)
...
- [`deutschlandatlas_query()`](https://buecker.ms/bunddev/reference/deutschlandatlas_query.md)
...
- [`feiertage_list()`](https://buecker.ms/bunddev/reference/feiertage_list.md)
  : List German public holidays

## Handelsregister

- [`handelsregister_search()`](https://buecker.ms/bunddev/reference/handelsregister_search.md)
...
- [`lebensmittelwarnung_warnings()`](https://buecker.ms/bunddev/reference/lebensmittelwarnung_warnings.md)
...
- [`regionalatlas_query()`](https://buecker.ms/bunddev/reference/regionalatlas_query.md)
